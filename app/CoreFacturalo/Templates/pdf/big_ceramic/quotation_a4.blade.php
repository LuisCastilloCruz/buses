...
<body>
<div style="position: absolute; left: 157px;top:15px;width: 79%;text-align:right;"> <b>COTIZACIÓN: {{ $tittle }}</b></div>
<div style="z-index: 1; position: absolute; left: 45px;padding-left:3px;padding-right: 20px;margin-top: -30px">
