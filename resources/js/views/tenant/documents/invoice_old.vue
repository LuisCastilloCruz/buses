...
<!--                                &lt;!&ndash; <el-checkbox v-model="form.has_prepayment" :disabled="prepayment_deduction">¿Es un pago anticipado?</el-checkbox>-->
<!--                                <el-checkbox v-model="prepayment_deduction" @change="changePrepaymentDeduction" :disabled="form.has_prepayment">Deducción de los pagos anticipados</el-checkbox> &ndash;&gt;-->
...
<!--                                &lt;!&ndash; <el-switch v-if="form.has_prepayment || prepayment_deduction" v-model="form.affectation_type_prepayment"-->
                        ...
                        <div class="row mt-1">
                            ...
                            <div class="col-lg-2">
                                <div class="form-group" :class="{'has-danger': errors.date_of_issue}">
                                    ...
                                    <el-date-picker v-model="form.date_of_issue" type="date" value-format="yyyy-MM-dd" :clearable="false"  :picker-options="datEmision"></el-date-picker>
...
<!--                                                                &lt;!&ndash; <el-option v-for="option in payment_destinations" @change="changeDestinationSale(index)" :key="option.id" :value="option.id" :label="option.description"></el-option> &ndash;&gt;-->
<!--                                                            </el-select>-->
<!--                                                        </div>-->
<!--                                                    </td>-->
<!--                                                    <td>-->
...
<!--                            </div>-->
<!--                                &lt;!&ndash; <div class="col-lg-4" v-if="form.operation_type_id == '1001'">-->
<!--                                    <div class="form-group">-->
...
<!--                                                        <i class="fa fa-trash"></i>-->
<!--                                                    </button>-->
<!--                                                    &lt;!&ndash; <a href="#" @click.prevent="clickRemovePrepayment" style="color:red">Remover</a> &ndash;&gt;-->
<!--                                                </td>-->
<!--                                            </tr>-->
<!--                                        </table>-->
<!--                                    </div>-->
    ...
    export default {
        ...
        methods: {
            ...
            async submit() {
                ...
                this.$http.post(`/documents`, this.form).then(response => {
                    if (response.data.success) {
                        this.$eventHub.$emit('reloadDataItems', null)
                        this.resetForm();
                        this.documentNewId = response.data.data.id;

                        this.clickChangeToRegisteredStatus(this.documentNewId);
