        ...
        <div class="nano-content">
            <nav id="menu" class="nav-main" role="navigation">
                <ul class="nav nav-main">
                    ...
                    {{ ($path[0] === 'account_formats')?'nav-active nav-expanded':'' }}
                    {{ ($path[0] === 'accounting')?'nav-active nav-expanded':'' }}
                    {{ ($path[0] === 'params')?'nav-active nav-expanded':'' }}
...
{{--                                    <li class="{{ (($path[0] === 'accounting') && ($path[1] === 'origenes')?'nav-active':'' }}">--}}
...
{{--                                        </a>--}}
{{--                                    </li>--}}
{{--                                    <li class="{{ ($path[0] === 'accounting' && $path[1] === 'persons')?'nav-active':'' }}">--}}
...
{{--                                        </a>--}}
{{--                                    </li>--}}
                                    <li class="{{ (($path[0] === 'accounting') && ($path[1] === 'params'))?'nav-active':'' }}">
                                        <a class="nav-link" href="{{route('tenant.accounting_params.index')}}">
                    ...
                    {{ ($path[0] === 'transportes') ? 'nav-active nav-expanded' : '' }}">
                            ...
                            <ul class="nav nav-children">
                                ...
                                <li class="{{ (($path[0] === 'transportes') && ($path[1] === 'reportes')) ? 'nav-active' : '' }}">
