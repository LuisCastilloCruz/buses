    ...
    <div class="container">
        <div class="row">
            <div class="col-8 py-5">
                <button v-on:click="obtener" data-id="22">Click Me</button>
                <div>
                    <table class="mx-auto">
                        <tr v-for="idxr, r in rows">
                            <td v-for="idxc, c in cols" class="pl-2" :id="idxr+idxc" style="width: 70px">

                                <svg @click="onSeatSelected(idxr, idxc,'5')" v-if="!isAisle(idxr, idxc)" id="Layer_1" data-name="Layer 1" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 100 100">
                                    ...
                                    <text x="10" y="20" style="fill:red;">
                                        <tspan x="30" y="60" font-size="32" :id="idxr"> 5 </tspan>
                                    </text>
                                </svg>
                            </td>
                        </tr>
